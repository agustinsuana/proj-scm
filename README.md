...
|-----------------------|----------------------------|
|Eduardo Medina         | SCMR                       |
|Fabiola Carrasco       | Especialista técnico, SQAR |
|Agustin Suaña          | VR                         |
...
Para todos los elementos de configuración se les deberá agregar, después del nombre del mismo, información acerca del grupo al que corresponde el elemento y la versión del mismo.
 ...
 El formato para esta nomenclatura es: **NomenclaturaG**X**v**Y.extensión, donde:
...
| SQAIR                                       |Informe de Revisión de SQA                                    |
...
|----------------------------------------|-------------------------------------------|---------------------------------------|
|Planificar el Plan de Configuración.    |Nada                                       |En curso.                              |
|Definir Línea Base del Proyecto         |Plan de Configuración.                     |Semana 4 probablemente.                |
|Realizar informe final de SCM           |Gestión de cambios Inf. de Línea Base del proyecto.Plan de Configuración.|Semana 14|
|Implementación del control de cambios.  |                                           |Semana 5 probablemente.                |
